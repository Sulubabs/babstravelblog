...
<?php } ?>
 ...
 <div class="row pt-3">
    ...
    <div class="col-8 m-auto card shadow p-3">
      ...
      <form action="updatecreatorprofile.php" method="POST" enctype="multipart/form-data">
      <div class="form-group p-2">
      <div class="row">
  <div class="col">
  <label for="title">Firstname:</label>
    <input required type="text" class="form-control" placeholder="First name" aria-label="First name" value="<?php echo $userobj['firstname']?>" name="firstname">
  </div>
  <div class="col">
  <label for="title">Lastname:</label>
    <input required type="text" class="form-control" placeholder="Last name" aria-label="Last name" value="<?php echo $userobj['lastname']?>" name="lastname">
  </div>
</div>
      <div class="form-group p-2">
      <div class="row">
  ...
  <label for="title">Facebook link:</label>
    <input type="text" class="form-control" placeholder="Facebook link" aria-label="Facebook link" value="<?php echo $userobj['facebook']?>" name="facebook">
  </div>
  <div class="col">
  <label for="title">Instagram Link:</label>
    <input type="text" class="form-control" placeholder="Instagram Link" aria-label="Instagram Link" value="<?php echo $userobj['instagram']?>" name="instagram">
  </div>
</div>
  ...
  <label for="title">Twitter Link:</label>
    <input type="text" class="form-control" placeholder="Twitter Link" aria-label="Twitter Link" name="twitter" value="<?php echo $userobj['twitter']?>">
  </div>
  <div class="col">
  <label for="title">Email:</label>
    <input required type="email" class="form-control" placeholder="Email" aria-label="Email" name="email" value="<?php echo $userobj['email']?>" disabled>
  </div>
</div>
  ...
  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description"><?php echo $userobj['description']?></textarea>
</div>
        </div>
