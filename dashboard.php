                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card shadow-sm bordered">
                            <img src="<?php echo $post_main_image; ?>" class="card-img-top" style="height:200px" alt="<?php echo $post_title; ?>">
                            <div class="card-body">
                                <h5 class="card-title"><a href="blog-details.php?postid=<?php echo $post_id?>" class="card-link"><?php echo $post_title; ?></a></h5>
