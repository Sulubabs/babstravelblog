        ...
        <table id="blog-posts-table" class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              if ($row['blocked']) {
                echo '<td class="text-danger">Hidden</td>';
              } else {
                echo '<td class="text-primary">Active</td>';
              }
              echo '<td>';
              if ($row['blocked']) {
                echo '<button class="btn btn-sm btn-warning" onclick="unblockPost(' . $row['id'] . ')">Unhide</button>';
              } else {
                echo '<button class="btn btn-sm btn-secondary" onclick="blockPost(' . $row['id'] . ')">Hide</button>';
              }
              echo ' <a href="#" class="btn btn-danger" onclick="deletePost(' . $row['id'] . ')">Delete</a></td>';
              echo '</tr>';
            }
